[![npm-version](https://img.shields.io/npm/v/@hchuang/react-doc-viewer.svg)](https://www.npmjs.com/package/@hchuang/react-doc-viewer)
[![npm-download](https://img.shields.io/npm/dt/@hchuang/react-doc-viewer.svg)](https://www.npmjs.com/package/@hchuang/react-doc-viewer)

# @hchuang/react-doc-viewer
...
```bash
 npm i @hchuang/react-doc-viewer
 # or
 yarn add @hchuang/react-doc-viewer
```
...
```tsx
import DocViewer, { PDFRenderer, PNGRenderer } from "@hchuang/react-doc-viewer";
...
import DocViewer from "@hchuang/react-doc-viewer";
...
If you need to prevent the actual loading of the file by `@hchuang/react-doc-viewer`.<br>
...
By default, `@hchuang/react-doc-viewer` fetches document metadata through a `HEAD` request in order to guess its `Content-Type`.
...
```tsx
import DocViewer, { DocViewerRef } from "@hchuang/react-doc-viewer";
